...
public interface GoalServiceHandler extends ServiceHandler {
    ...
    GoalRepresentation updateGoal(StrategyRequest request) throws DBServiceException, GoalNotFoundException, ActionServiceFailedException;
    ListGoalRepresentation getGoal(StrategyRequest request) throws DBServiceException, LayoutNotFoundException;
    GoalRepresentation getGoalInfo(StrategyRequest request) throws DBServiceException, GoalNotFoundException, ActionServiceFailedException;
