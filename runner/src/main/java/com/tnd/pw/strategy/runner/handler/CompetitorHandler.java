...
public class CompetitorHandler implements BaseHandler {
    ...
    public BaseResponse<ListCompetitorRepresentation> addCompetitor(StrategyRequest request) throws DBServiceException, CompetitorNotFoundException {
    ...
    public BaseResponse<CompetitorRepresentation> updateCompetitor(StrategyRequest request) throws DBServiceException, CompetitorNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<ListCompetitorRepresentation> getCompetitor(StrategyRequest request) throws DBServiceException, LayoutNotFoundException {
    ...
    public BaseResponse<CompetitorRepresentation> getCompetitorInfo(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, CompetitorNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<ListCompetitorRepresentation> removeCompetitor(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, CompetitorNotFoundException {
