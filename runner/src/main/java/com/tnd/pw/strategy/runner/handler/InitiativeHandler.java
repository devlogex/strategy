...
public class InitiativeHandler implements BaseHandler {
    ...
    public BaseResponse<ListInitiativeRepresentation> addInitiative(StrategyRequest request) throws IOException, DBServiceException, InitiativeNotFoundException {
    ...
    public BaseResponse<ListInitiativeRepresentation> updateInitiativeState(StrategyRequest request) throws DBServiceException, IOException, InitiativeNotFoundException, LayoutNotFoundException, InvalidDataRequestException {
    ...
    public BaseResponse<ListInitiativeRepresentation> getInitiative(StrategyRequest request) throws DBServiceException, IOException, LayoutNotFoundException {
    ...
    public BaseResponse<ListInitiativeRepresentation> getInitiativeState(StrategyRequest request) throws DBServiceException, IOException, LayoutNotFoundException {
    ...
    public BaseResponse<ListInitiativeRepresentation> removeInitiative(StrategyRequest request) throws DBServiceException, IOException, LayoutNotFoundException, InitiativeNotFoundException {
