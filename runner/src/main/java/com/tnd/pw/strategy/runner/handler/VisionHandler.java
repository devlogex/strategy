...
public class VisionHandler implements BaseHandler {
    ...
    public BaseResponse<VisionRepresentation> addVision(StrategyRequest request) throws DBServiceException {
    ...
    public BaseResponse<VisionRepresentation> updateVision(StrategyRequest request) throws DBServiceException, VisionNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<VisionRepresentation> getVision(StrategyRequest request) throws DBServiceException, ActionServiceFailedException {
    ...
    public BaseResponse<ListVisionComponentRep> addVisionComponent(StrategyRequest request) throws DBServiceException, VisionNotFoundException, LayoutNotFoundException, VisionComponentNotFoundException {
    ...
    public BaseResponse<VisionComponentRep> updateVisionComponent(StrategyRequest request) throws DBServiceException, VisionComponentNotFoundException {
    ...
    public BaseResponse<ListVisionComponentRep> getVisionComponentById(StrategyRequest request) throws DBServiceException {
    ...
    public BaseResponse<ListVisionComponentRep> getVisionComponentByVisionId(StrategyRequest request) throws DBServiceException {
    ...
    public BaseResponse<ListVisionComponentRep> removeVisionComponent(StrategyRequest request) throws DBServiceException, VisionComponentNotFoundException, LayoutNotFoundException {
