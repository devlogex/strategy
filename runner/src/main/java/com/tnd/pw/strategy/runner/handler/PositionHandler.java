...
public class PositionHandler  implements BaseHandler {
    ...
    public BaseResponse<ListPositionRepresentation> addPosition(StrategyRequest request) throws DBServiceException, PositionNotFoundException {
    ...
    public BaseResponse<PositionRepresentation> updatePosition(StrategyRequest request) throws DBServiceException, PositionNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<ListPositionRepresentation> getPosition(StrategyRequest request) throws DBServiceException, LayoutNotFoundException {
    ...
    public BaseResponse<PositionRepresentation> getPositionInfo(StrategyRequest request) throws DBServiceException, PositionNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<ListPositionRepresentation> removePosition(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, PositionNotFoundException {
    ...
    public BaseResponse<LayoutRepresentation> addPositionComponent(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, PositionComponentNotFoundException {
    ...
    public BaseResponse<PositionComponentRep> updatePositionComponent(StrategyRequest request) throws DBServiceException, PositionComponentNotFoundException {
    ...
    public BaseResponse<LayoutRepresentation> getPositionComponentById(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, PositionComponentNotFoundException {
    ...
    public BaseResponse<LayoutRepresentation> getPositionComponentByPositionId(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, PositionComponentNotFoundException {
    ...
    public BaseResponse<LayoutRepresentation> removePositionComponent(StrategyRequest request) throws DBServiceException, LayoutNotFoundException, PositionComponentNotFoundException {
    ...
    public BaseResponse<FilterInfoRepresentation> getFilterInfos(StrategyRequest request) throws DBServiceException, LayoutNotFoundException {
