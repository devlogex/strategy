...
public interface PersonasServiceHandler extends ServiceHandler{
    ...
    PersonasRepresentation updatePersonas(StrategyRequest request) throws DBServiceException, IOException, PersonasNotFoundException, CallApiFailException;
    ...
    PersonasRepresentation getPersonasInfo(StrategyRequest request) throws DBServiceException, PersonasNotFoundException, IOException, CallApiFailException;
